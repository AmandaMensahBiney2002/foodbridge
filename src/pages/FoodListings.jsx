...
function FoodListings() {
  ...
  const handleClose = async (listingId) => {
    const confirmed = window.confirm(
      "Are you sure you want to close this food listing? Recipients will no longer be able to request food from it."
    );
    ...
    try {
      ...
      if (!response.ok) {
        throw new Error(
          data.error || "Failed to close food listing"
        );
      }
  ...
  return (
    <div className="min-h-screen bg-[#FFFDF5] px-6 py-12 text-[#3F352C] md:px-12">
      <div className="mx-auto max-w-6xl">
        ...
        {error && (
          <p className="mt-10 rounded-xl bg-red-50 p-4 text-red-600">
            {error}
          </p>
        )}
            ...
            {listings.map((listing) => (
              ...
              >
                  ...
                  <div className="mt-auto pt-6">
                    ...
                    {listing.status === "available" && (
                      <button
                        ...
                        className="mt-3 w-full rounded-xl border-2 border-[#D9A441] px-4 py-3 font-bold text-[#8A6818] transition hover:bg-[#FFF7DD] disabled:cursor-not-allowed disabled:opacity-60"
                      >
                ...
                {!isDonor &&
                  listing.status === "closed" && (
                    <div className="mt-auto pt-6">
                      <div className="rounded-xl bg-gray-100 px-4 py-3 text-center text-sm font-semibold text-gray-500">
